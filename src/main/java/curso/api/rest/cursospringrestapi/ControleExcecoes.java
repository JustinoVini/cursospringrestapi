...
/* Interceptador de excecao */
@RestControllerAdvice // faz com que possamos consolidar multiplos exceptions
@ControllerAdvice
public class ControleExcecoes extends ResponseEntityExceptionHandler {
    ...
    /*Tratamento da maioria dos erros a nivel de banco de dados (, PSQLException.class)*/
    ...
    protected ResponseEntity<Object> handleExceptionDataIntegry(Exception e) {
        ...
        if (e instanceof DataIntegrityViolationException) {
            ...
            msg = e.getMessage(); /*Tratamento para eventos mais genericos*/
        }
